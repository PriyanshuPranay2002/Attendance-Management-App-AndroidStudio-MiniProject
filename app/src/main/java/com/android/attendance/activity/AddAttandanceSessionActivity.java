...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	private String[] branchString = new String[] { "CCE"};
	private String[] yearString = new String[] {"1st","2nd","3rd"};
	private String[] subjectSEString = new String[] {"MAD","NS"};
	private String[] subjectTEString = new String[] {"ES","EEFM"};
	private String[] subjectBEString = new String[] {"WCC","OE"};

	private String[] subjectFinal = new String[] {"MAD Lab","ES Lab","NS Lab"};
